                            ...
                            <tr>
                                <td style="font-size:0px;padding:10px 25px;padding-top:20;padding-right:0px;padding-bottom:0px;padding-left:0px;word-break:break-word;">
                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                           style="border-top:solid 1px #f8f8f8;font-size:1;margin:0px auto;width:600px;"
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Helvetica Neue;font-size:13px;line-height:1;text-align:left;color:#03b7ff;">
                                        <strong>
                                            <a href="{{env('CMS_DOMAIN_SECURE') ? 'https:' : 'http:'}}//{{env('EMAIL_DOMAIN') . '/activate-account/' . $ConfirmCode}}">Activate me!</a>
                                        </strong>
                                    </div>
